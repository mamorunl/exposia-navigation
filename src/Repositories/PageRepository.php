...
class PageRepository extends AbstractRepository
{
    ...
    protected function recursiveRenderForEdit($row)
    {
        ...
        foreach ($row['columns'] as $column) {
            ...
            $html .= '<div class="' . $classes['class_length'] . ' rg-col">';
            $html .= '<div class="p7 xpo_data ' . ((isset($column['template_name']) && strlen($column['template_name']) > 0) ? '' : 'text-center') . '" data-custom-class="' . $classes['custom_class'] . '">';
            ...
            $html .= (isset($column['template_name']) && strlen($column['template_name']) > 0) ? TemplateParser::parseForInput($column['template_name'],
                $column['template_data']) : '<a href="#" class="rg-pick-col-template btn btn-primary"><i class="fa fa-crosshairs"></i></a>';
            $html .= '</div>';
